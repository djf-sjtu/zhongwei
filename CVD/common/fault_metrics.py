# -*- coding: utf-8 -*-
"""Fault-scenario metrics for CVD scheduling."""
import copy
import json
import logging
import time
...
class FaultMetrics:
    """Collect quality and throughput signals without changing scheduling."""

    def __init__(self):
        self.start_time: Optional[float] = None
        self.end_time: Optional[float] = None
        self.affected_wafer_ids = set()
        self.storage_overruns: Dict[object, float] = {}
    ...
    def on_process_completed(self, wafer_id):
    ...
    def on_wafer_completed(self, wafer_id):
        self.completed_wafer_count += 1

    def ignore_wafer(self, wafer_id):
    ...
    def summary(self) -> dict:
        ...
        return {
            ...
            'affected_wafer_ids': sorted(self.affected_wafer_ids, key=str),
    ...
    def log_summary(self):
        ...
        logging.info("")
        logging.info("=" * 80)
        logging.info("CVD Fault Metrics")
        logging.info("=" * 80)
    ...
    def _record_storage_duration(self, wafer_id, storage_duration: float):
